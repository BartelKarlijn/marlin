 ...
 */
#define E0_AUTO_FAN_PIN P2_04  //Use extra heater to drive cooling fans (case/hotend/psu)
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 70 }, { 200,  70 }, { 200, 200 }, { 20, 200 } }
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 2.00        // (mm) Compression length applying to all extruders
  #endif
...
//From https://3dprint.wiki/reprap/anet/a8/steppermotor
// The stepper motors used in Anet A8 (as bought in may 2018) are NEMA 17 42SHDC3025-24B. Here is link to the official shop.
...
// Weight 280g
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       650        // (mA) RMS current. Multiply by 1.414 for peak current.  At default 900, motors became too(?) hot
    ...
    #define Y_CURRENT       900      // (replacement) Ymotor says 1.70amps/phase.  Not sure if you need to devide it by 1.414 but that gives 1200
